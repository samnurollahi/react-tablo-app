        ...
        {isPopupOpen && (
          <>
            <div className="fixed inset-0  flex justify-center items-center z-50">
              <div className="bg-white p-6 rounded-lg shadow-lg w-[90%] md:w-[400px] z-50">
                <h2 className="text-xl font-bold mb-4">درباره ما</h2>
                <p className="text-gray-700 mb-4">
                  این یک متن نمونه برای پاپ‌آپ است. شما می‌توانید این متن را با
                  محتوای دلخواه خود جایگزین کنید.
                </p>
                <button
